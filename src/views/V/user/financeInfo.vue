<template>
    ...
    <div class="my-bag-wrapper">
        <div class="userinfo-nav">
            ...
            <el-button :type="navIndex==2?'sure':'text'" @click="recordList('-1',1),navIndex=2">{{$lang('我的账单')}}
            </el-button>
        </div>
        <!-- 我的钱包-资金 -->
        <div class="mybag-zj-wrap" v-if="navIndex==1">
            ...
            <div class="mybag-zj-show" v-if="operateType=='index'">
                <el-row>
                    <el-col :span="24">
                        <div class="l_allincome">总收入：<span class="l_allprice">{{totalMoney}}</span></div>
                    </el-col>
                </el-row>
                    ...
                    <div class="txcz-wrap">
                            ...
                            <el-form-item :label="$lang('请选择提现方式')">
                                <template>
                                    <ul class="clearfix">
                                        ...
                                        <li class="zffs-li" :class="cashForm.atmType==2&&'active'"
                                            @click="changeType(2)">
                        ...
                        <el-row style="margin:10px 0px;text-align:center;" v-if="cashForm.atmType==2">
                            ...
                            <div style="margin:10px;color:red;">
                                {{$lang('根据《中华人民共和国个人所得税法》和《中华人民共和国个人所得税法实施条例》的要求，月收入超出3500的部分需缴纳个人所得税')}}
                            </div>
                        </el-row>
                    </div>
                </div>
        ...
        <div class="mybag-zd-wrap" v-if="navIndex==2">
            <ul class="zd-nav-ul clearfix">
                <li class="zd-nav" :class="billIndex==1?'active':null"><a href="javascript:;"
                                                                          @click="recordList('-1',1)">{{$lang('全部')}}</a>
                </li>
                <li class="zd-nav" :class="billIndex==2?'active':null"><a href="javascript:;"
                                                                          @click="recordList('项目收入',2)">{{$lang('项目收入')}}</a>
                </li>
                <li class="zd-nav" :class="billIndex==3?'active':null"><a href="javascript:;"
                                                                          @click="recordList('提现',3)">{{$lang('提现')}}</a>
                </li>
            </ul>
