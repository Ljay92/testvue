        ...
        <div class="check-accept-wrapper">
            ...
            <div class="star-rating-wrap">
              ...
              <div class="rating-wrap">
                ...
                <div class="tag-wrap">
                  <button v-for="tagLable in tagLableArr" :key="tagLable.id" class="tag-button" @click="tagSelected($lang(tagLable.id))" v-bind:class="{'tag-button-selected':tagLableSelected===$lang(tagLable.id)}">{{$lang(tagLable.value)}}</button>
                </div>
...
export default {
  ...
  async mounted() {
    ...
    let res =  await getReasonParam('S');
