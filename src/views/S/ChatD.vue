    ...
    <div class="chart-wrpaper clearfix">
        <div class="chart-left">
            <div class="box-flex-media-box">
                ...
                <el-button type="sure"
                           @click="$router.push({name:'S_ChatT', query: {id:subTask.taskId,state:subTask.state}})"
                           v-if="subTask">&lt;{{$lang('返回总任务')}}
                </el-button>
                ...
                <ul class="chart-left-ul">
                    ...
                    <li class="chart-left-li" v-for="(item,i) in taskStage" :key="i">
                        <div class="box-flex-media-box cl-top">
                            ...
                            <el-button type="info" size="small" @click="toRedirect('S_History', i)">{{$lang('查看记录')}}
                            </el-button>
                        </div>
        ...
        <div v-if="Object.keys(chatConfig).length>0">
            <Chat ref="chat" :chatConfig="chatConfig" :isReserve="false"
                  :isHistory="['8','10'].includes(subTask.state)"></Chat>
        </div>
        ...
        <el-dialog :title="$lang('上传文件')" ref="toSubmitUpload" :visible.sync="toSubmitUploadShow" size="tiny"
            ...
            <el-form>
                ...
                <el-form-item :label="$lang('资源文件：')">
                    ...
                    <el-upload action="https://jsonplaceholder.typicode.com/posts/" ref="indexFile"
...
<script>
    ...
    import {ChildTaskInfo, AcceptanceTask, getTalkByGroupId,JudgeNew} from "@/apis/task";
