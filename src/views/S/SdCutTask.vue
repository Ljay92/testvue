                    ...
                    <el-row>
                        <el-row>
                            <el-col :span="12">
                                <el-form-item :label="$lang('应用领域:')" required>
                                    <el-select v-model="form.appAreas" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.areaList" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('应用环境:')" required>
                                    <el-select v-model="form.vevironments" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.enviList" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('应用类别:')" required>
                                    <Type-Select :onChange="AppClassChange" :value="form.appType"
                                                 :dataSource="configs.AppClass"></Type-Select>
                                </el-form-item>
                                ...
                                <el-form-item :label="$lang('模型风格:')" required>
                                    <el-select v-model="form.chartlatFormat" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.mapModelList" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('贴图大小:')" required>
                                    <el-select v-model="form.chartlatSize" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.mapSizeList" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('模型格式:')" required>
                                    <el-select v-model="form.modelStyle" multiple :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.mapModelStyleList" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('贴图格式:')" required>
                                    <el-select v-model="form.chartlatProperty2" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.mapStyle" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('模型精度:')" required>
                                    <el-select v-model="form.chartlatProperty3" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.modelAccuracy" :key="item.key"
                                                   :label="item.cnValue" :value="item.key"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item :label="$lang('场景制作单位:')" required>
                                    <el-select v-model="form.chartlatProperty4" :placeholder="$lang('请选择')"
                                               class="select-width-all">
                                        <el-option v-for="item in configs.sightUnit" :key="item.key+'/'+item.cnValue"
                                                   :label="item.cnValue" :value="item.key+'/'+item.cnValue"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <div class="jdx-add-task">
                            ...
                            <el-row v-for="(item,i) in form.taskStages" :key="i">
                                ...
                                <el-col :span="22">
                                    <el-form-item :label="$lang('阶段说明:')" required>
                                        <el-input type="textarea" v-model="item.backup.stageRemarks" :rows="5"
                                                  :placeholder="$lang('请输入内容')" v-if="item.editable"></el-input>
                            ...
                            <el-row>
                                ...
                                <el-col :span="22">
                                    <el-form-item :label="$lang('阶段说明:')" required>
                                        <el-input type="textarea" v-model="stage.stageRemarks" :rows="5"
                                                  :placeholder="$lang('请输入内容')"></el-input>
                                    </el-form-item>
                                </el-col>
                        ...
                        <el-form-item :label="$lang('参考图片:')" class="update-images-list" required>
                            <el-upload ref="ReferencePicture" action="https://jsonplaceholder.typicode.com/posts/"
                                       list-type="picture-card" :on-remove="removeFile"
                                       :on-change="ReferencePictureChange" :file-list="ReferencePictureFileList"
                        ...
                        <el-row>
                            <el-col :span="12" class="update-text">
                                <el-form-item :label="$lang('附件:')" required>
                                    <el-upload class="upload-demo" ref="EnclosureFile"
                                               action="https://jsonplaceholder.typicode.com/posts/"
                                               :on-remove="removeFile" :file-list="EnclosureFileList"
                                               :auto-upload="false" :multiple="true">
                                        <el-button slot="trigger" size="small" type="primary">{{$lang('添加文件')}}
                                        </el-button>
                                    </el-upload>
                                </el-form-item>
                            </el-col>
                        ...
                        <!--</el-form-item>-->
                        <el-form-item :label="$lang('备注:')">
                            <UE :defaultMsg="form.remarks" :config=config :id=ue1 ref="ue"></UE>
                        </el-form-item>
